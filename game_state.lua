...
local gameState = {
    ...
    allItems = {
        ...
        {name="Wall Master", desc="Every 5th wall hit gives 1000 points", price=40, id="wallMasterPopper"}
    },
...
function gameState:reset()
    ...
    self.round = 1
    self.lives = config.START_LIVES + (self.permanentExtraLives or 0)
